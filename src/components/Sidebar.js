...
import {
  FaUser, FaBriefcase, FaServicestack, FaFileAlt, FaBlog, FaEnvelope,
  FaLinkedin, FaFacebook, FaInstagram, FaTwitter, FaMoon, FaSun
} from "react-icons/fa";
    ...
    <div className={`sidebar ${darkMode ? "dark" : ""}`}>
      <div className="top-section">
        ...
        <p className="description">
          Hi, my name is M V Arun Prasad and I'm a senior software engineer. Welcome to my personal website!
        </p>
